...
const Internships = () => {
  ...
  const fetchInternshipBlogs = async () => {
    try {
      ...
      console.error('Error fetching internship blogs:', error);
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-purple-700 dark:text-purple-300 font-medium">Internship Opportunities</span>
          </div>
          <h1 className="text-5xl font-bold text-gray-900 dark:text-gray-100 mb-4">
            Internship 
            <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent"> Opportunities</span>
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Launch your career with exciting internship opportunities across various industries.
          </p>
        </div>
        ...
        {isLoading ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">Loading internship opportunities...</p>
          </div>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">
              {searchTerm ? 'No internship opportunities found' : 'No internship opportunities yet'}
            </h3>
            <p className="text-gray-600 dark:text-gray-400">
              {searchTerm ? 'Try adjusting your search terms.' : 'New internship opportunities coming soon!'}
            </p>
          </div>
        ) : (
            ...
            {filteredBlogs.map((blog) => (
              <Card key={blog.id} className="group hover:shadow-2xl transition-all duration-300 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 shadow-lg hover:-translate-y-2">
                ...
                <CardContent className="p-6">
                  ...
                  >
                    <button className="w-full bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white px-4 py-3 rounded-lg font-medium transition-all duration-200 group-hover/link:shadow-lg flex items-center justify-center gap-2">
                      View Details
